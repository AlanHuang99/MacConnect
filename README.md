...
- **Two-way media control (MPRIS)** — control a peer's playback and volume from its now-playing tile, or use KDE Connect Android to control the Mac's active system media session and output volume.
